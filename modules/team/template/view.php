...
<?php if($settings['style'] == 'style1') :?>
    ...
    <?php if($settings['style'] == 'style2') :?>
        ...
        <?php if($settings['style'] == 'style5') : ?>
                ...
                <div class="advanced_addons_team_member type-4  position-relative overflow-hidden">
						<div class="hoverable_content position-absolute">
							<a href="<?php echo esc_url($settings['pro_link']);?>">
								<i class="icon-arrows_circle_plus"></i>
							</a>
						</div>
						<div class="advanced_addons_team_member_image rounded-circle ">
							<img src="<?php echo $settings['image']['url'];?>" class="img-fluid" alt="">
						</div>
						<div class="advanced_addons_team_member_content text-center bg-white">
                            <?php if ( $settings['title'] ) :
                                printf( '<%1$s %2$s>%3$s</%1$s>',
                                    tag_escape( $settings['title_tag'] ),
                                    $this->get_render_attribute_string( 'title3' ),

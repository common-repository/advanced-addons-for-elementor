 ...
 * @since 1.0.0
 */
class AAE_Caldera_Forms extends Widget_Base {

	public function get_name() {
		return 'aae-caldera-forms';
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
			'_section_cf',
			[
				'label' => Advance_Addons_is_calderaf_activated() ? __( 'Caldera Forms', 'aa_elementor' ) : __( 'Notice', 'aa_elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'options' => ['' => __( '', 'aa_elementor' ) ] + \Advance_Addons_get_caldera_form(),
            ]
        );
	...
	protected function render() {
		require AAE_PATH . '/modules/caldera-forms/template/view.php';
    }

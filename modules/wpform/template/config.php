 ...
 * @since 1.0.0
 */
class AAE_Wpform extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
			'_section_wpf',
			[
				'label' => Advance_Addons_is_wpf_activated() ? __( 'WPForms', 'aa_elementor' ) : __( 'Notice', 'aa_elementor' ),
	...
	protected function render() {
		require AAE_PATH . '/modules/wpform/template/view.php';
    }

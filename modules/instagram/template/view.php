...
$this->add_render_attribute( 'advanced_instragram', 'class', 'advanced-instragram' );
        ...
        $id     = !empty( $check_component_active['instagram_user_id'] ) ? $check_component_active['instagram_user_id'] : 6666969077;
        $token  = !empty( $check_component_active['instagram_access_token'] ) ? $check_component_active['instagram_access_token'] : '6666969077.1677ed0.d325f406d94c4dfab939137c5c2cc6c2';

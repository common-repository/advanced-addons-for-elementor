 ...
 * @since 1.0.0
 */
class AAE_Twitter_Feed extends Widget_Base {

	public function get_name() {
		return 'aae-twitter-feed';
	}

	public function get_title() {
		return esc_html__( 'Twitter Feeds', 'aa_elementor' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .advanced_addons_twitter_feed' => 'background: {{VALUE}} !important',
                ],
            ]
        );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .advanced_addons_twitter_feed' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .advanced_addons_twitter_feed' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .advanced_addons_twitter_feed' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .username' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .date' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .textc' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Meta Section', 'aa_elementor' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .meta li a' => 'color: {{VALUE}} !important',
                ],
            ]
        );
	...
	protected function render() {
		require AAE_PATH . '/modules/twitter-feed/template/view.php';
    }

    // protected function _content_template() {
	// 	require AAE_PATH . '/modules/twitter-feed/template/content-template.php';
    // }

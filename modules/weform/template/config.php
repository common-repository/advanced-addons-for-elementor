 ...
 * @since 1.0.0
 */
class AAE_Weform extends Widget_Base {
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'_section_weform',
			[
				'label' => Advance_Addons_is_weform_activated() ? __( 'weForms', 'aa_elementor' ) : __( 'Notice', 'aa_elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
				'options' => ['' => __( '', 'aa_elementor' ) ] + \Advance_Addons_get_we_forms(),
            ]
        );
	...
	protected function render() {
		require AAE_PATH . '/modules/weform/template/view.php';
    }

    // protected function _content_template() {
	// 	require AAE_PATH . '/modules/weform/template/content-template.php';
    // }

 ...
 * @since 1.0.0
 */
class AAE_Gravity_Forms extends Widget_Base {

	public function get_name() {
		return 'aae-gravity-forms';
	}
	...
	public function get_script_depends() {
		return [ 'aae-for-elementor-gravity-forms' ];
    }
	...
	protected function render() {
		require AAE_PATH . '/modules/gravity-forms/template/view.php';
    }

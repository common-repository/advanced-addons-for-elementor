...
class Cf7 extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
			'_section_cf7',
			[
				'label' => Advance_Addons_is_cf7_activated() ? __( 'Contact Form 7', 'aa_elementor' ) : __( 'Notice', 'aa_elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'options' => ['' => __( '', 'aa_elementor' ) ] + \Advance_Addons_get_cf7_forms(),
            ]
        );
	...
	protected function render() {
		require AAE_PATH . '/modules/cf7/template/view.php';
    }

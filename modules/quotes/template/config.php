 ...
 * @since 1.0.0
 */
class AAE_Quotes extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Quotes', 'aa_elementor' );
	}

	public function get_icon() {
		return 'ad ad-tree-square';
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'default'     => __( 'Quotes', 'aa_elementor' ),
				'placeholder' => __( 'Type Quotes title here', 'aa_elementor' ),
				'condition'   => [
        ...
        $this->add_control(
			'author',
			[
				'label'       => __( 'Author Name', 'aa_elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => __( '— Injected humour', 'aa_elementor' ),
				'placeholder' => __( 'Type Author Name here', 'aa_elementor' ),
				'condition'   => [
				...
				$this->add_responsive_control(
					...
					[
							...
							'toggle'    => true,
							'selectors' => [
									'{{WRAPPER}} .advanced_addons_quotes_card' => 'text-align: {{VALUE}}'
							]
					]
			);
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => __( 'Quotes Style', 'aa_elementor' ),
            ...
            $this->start_controls_section(
                '_section_style_auth',
                [
                    'label'     => __( 'Author Style', 'aa_elementor' ),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style' => ['style2','style3']
                    ]
            ...
            $this->add_control(
                'auth_bg',
                [
                    'label'     => __( 'Author Background', 'aa_elementor' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .advanced_addons_quotes_card.type-3 span::before' => 'background: {{VALUE}} !important',
                    ],
                    'condition' => [
                        'style' => ['style3']
                    ]
            ...
            $this->add_responsive_control(
                'auth_padding',
                [
                    'label'      => __( 'Author Padding', 'aa_elementor' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors'  => [
                        '{{WRAPPER}} .auth' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                'auth_margin',
                [
                    'label'      => __( 'Author Margin', 'aa_elementor' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors'  => [
                        '{{WRAPPER}} .auth' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .q-icon i' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .advanced_addons_quotes_card.type-4 .advanced_addons_quotes_icon' => 'background: {{VALUE}} !important',
                ],
                'condition' => [
                    'style' => ['style4']
                ]
	...
	protected function render() {
		require AAE_PATH . '/modules/quotes/template/view.php';
    }
    
    // protected function _content_template() {
	// 	require AAE_PATH . '/modules/quotes/template/content-template.php';
    // }

 ...
 * @since 1.0.0
 */
class AAE_Ninjaform extends Widget_Base {

	public function get_name() {
		return 'aae-ninjaform';
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
			'_section_ninjaf',
			[
				'label' => Advance_Addons_is_ninjaf_activated() ? __( 'Ninja Forms', 'aa_elementor' ) : __( 'Notice', 'aa_elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
				'options' => ['' => __( '', 'aa_elementor' ) ] + \Advance_Addons_get_ninjaform(),
            ]
        );
	...
	protected function render() {
		require AAE_PATH . '/modules/ninjaform/template/view.php';
	}

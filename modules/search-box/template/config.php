 ...
 * @since 1.0.0
 */
class AAE_Search_Box extends Widget_Base {

	public function get_name() {
		return 'aae-search-box';
	}

	public function get_title() {
		return esc_html__( 'Search Box', 'aa_elementor' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'Search hare', 'aa_elementor' ),
                'placeholder' => __( 'Type Search Title', 'aa_elementor' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'Lorem Ipsum is simply dummy ', 'aa_elementor' ),
                'placeholder' => __( 'Type Search description', 'aa_elementor' ),
                'rows'        => 5
            ]
        );
        ...
        $this->add_control(
            'placeholder',
            [
                'label'       => __( 'Placeholder Text', 'aa_elementor' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'default'     => __( 'Search hare', 'aa_elementor' ),
                'placeholder' => __( 'Type Search Placeholder Text', 'aa_elementor' ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Search Box Content', 'aa_elementor' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Search Input', 'aa_elementor' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
		...
		$this->add_control(
            'input_color',
            [
                'label'     => __( 'Input Color', 'aa_elementor' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .advanced_addons_search_box.type-1 .advanced_addons_field' => 'color: {{VALUE}}',
                ],
            ]
        );
		...
		$this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .advanced_addons_search_box.type-1 .advanced_addons_field' => 'border-color: {{VALUE}}',
                ],
            ]
        );
	...
	protected function render() {
		require AAE_PATH . '/modules/search-box/template/view.php';
    }

    // protected function _content_template() {
	// 	require AAE_PATH . '/modules/search-box/template/content-template.php';
    // }

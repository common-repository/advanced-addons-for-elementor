...
function advanced_addons_gravity_forms_options() {
    ...
    if ( false === $data ) {
        if ( class_exists( 'GFCommon' ) ) {
            ...
            $form_options = ['0' => esc_html__( 'Select Form', 'aa_elementor' )];
            ...
            $form_options = ['0' => esc_html__( 'Form Not Found!', 'aa_elementor' ) ];
        }
    ...
    function Advance_Addons_get_ninjaform() {
        ...
        if ( class_exists( 'Ninja_Forms' ) ) {
            ...
            if ( !empty($contact_forms) && !is_wp_error( $contact_forms ) ) {
                ...
                $options[0] = esc_html__( 'Select Ninja Form', 'aa_elementor' );
            ...
            $options[0] = esc_html__( 'Create a Form First', 'aa_elementor' );
        }
...
if ( ! function_exists( 'Advance_Addons_get_caldera_form' ) ) {
	...
	function Advance_Addons_get_caldera_form() {
		...
		if ( class_exists( 'Caldera_Forms' ) ) {
			...
			if ( !empty( $contact_forms ) && !is_wp_error( $contact_forms ) ) {
				$options[0] = esc_html__( 'Select a Caldera Form', 'aa_elementor' );
				foreach ( $contact_forms as $form ) {
...
if ( ! function_exists( 'Advance_Addons_get_modula_gallery' ) ) {
	...
	function Advance_Addons_get_modula_gallery() {
        ...
        if ( ! empty( $gallery ) ) {
			...
			__( 'Create a Gallery', 'aa_elementor' );
		}
        return [];
	}
}
